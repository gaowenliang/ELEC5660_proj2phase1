...
void img_callback(const sensor_msgs::ImageConstPtr &img_msg)
{
    ...
    float probDetect = TheBoardDetector.detect(Markers, TheBoardConfig, TheBoardDetected, CamParam, TheMarkerSize);
    ...
    for (unsigned int i = 0; i < Markers.size(); i++)
    {
        ...
        for (unsigned int j = 0; j < 4; j++)
        {
            ...
            pts_3.push_back( Minfo.at( j ) * TheMarkerSize / 1000 );
        }
    }
